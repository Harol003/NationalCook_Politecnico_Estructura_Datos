 ...
 */
package nationalcooklistagenericadiversa;
...
public class NationalCookListaGenericaDiversa {
    public static void main(String[] args) {
        // Crear y configurar el JFrame principal
        JFrame frame = new JFrame("NationalCookListaGenericaDiversa | Politecnico Internacional");
