...
public class NationalCookPila {
    public static void main(String[] args) {
        // Crear y configurar el JFrame principal
        JFrame frame = new JFrame("NationalCookPila | Politecnico Internacional");
        ...
        // Crear una pila de objetos Restaurante
        Stack<Restaurante> restaurantes = new Stack<>();
        restaurantes.push(new Restaurante("Andrés Carne de Res", "Fusión", 4.5));
        restaurantes.push(new Restaurante("Leo Cocina y Cava", "Gourmet", 4.8));
        restaurantes.push(new Restaurante("Harry Sasson", "Internacional", 4.2));
        restaurantes.push(new Restaurante("Criterion", "Contemporánea", 4.7));
        restaurantes.push(new Restaurante("El Cielo", "Molecular", 4.6));
        ...
        // Agregar los restaurantes de la pila al JTextArea (desde el tope de la pila)
        while (!restaurantes.isEmpty()) {
            Restaurante restaurante = restaurantes.pop();
            restaurantesTextArea.append(restaurante + "\n");
        }
